        ...
        return declare(null, { 
			...
			eventListeners: function(t){
				...
				$("#" + t.id + "viewInfoGraphic").on('click',function(c){
					TINY.box.show({
						animate: true, url: 'plugins/community-rating-system-ga/html/info-graphic.html',
				...
				$('#' + t.id + 'dlBtn').on('click',  function(){
					window.open("https://crs-maps.coastalresilience.org/" + t.obj.crsNoSpace + "_Maps.zip", "_parent");
				});	
