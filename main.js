...
function ( 	declare, PluginBase, ContentPane, dom, domStyle, domGeom, obj, content, esriapi, clicks, future, parcels, lang ) {
	return declare(PluginBase, {
		...
		initialize: function (frameworkParameters) {
			...
			this.url = "https://dev-services.coastalresilience.org/arcgis/rest/services/Georgia/CRS_Explorer/MapServer";
			this.layerDefs = [];
		},
		...
		render: function() {
			...
			// ADD HTML TO APP
			$(this.container).parent().append('<button id="viewCrsInfoGraphicIcon" class="button button-default ig-icon"><img src="plugins/community-rating-system-ga/images/InfographicIcon_v1_23x23.png" alt="show overview graphic"></button>')
			$(this.container).parent().find("#viewCrsInfoGraphicIcon").on('click',function(c){
				TINY.box.show({
					animate: true,
					url: 'plugins/community-rating-system-ga/html/info-graphic.html',
					fixed: true,
					width: 660,
					height: 570
				});
